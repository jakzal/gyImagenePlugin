...
/**
 * gyImageMagickAdapter provides a mechanism for creating thumbnail images.
...
class gyImageMagickAdapter
{
  ...
  public function save($thumbnail, $thumbDest, $targetMime = null)
  {
    ...
    if (isset($this->options['watermark_path']))
    {
      ...
      if (!isset($this->options['watermark_min_width']) || $this->options['watermark_min_width'] <= $thumbWidth
      ||  !isset($this->options['watermark_min_height']) || $this->options['watermark_min_height'] <= $thumbHeight)
      {
